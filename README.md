...
|---------------|--------------------|-------------------|------------------------------------|
| [Credit Card Fraud Detection with Decision Trees and SVM](https://github.com/sarikasea/Machine-Learning/blob/main/Credit_Card_Fraud_Detection_with_Decision_Trees_and_SVM.ipynb) | Detect fraudulent financial transactions using decision trees and support vector machines. | Finance | Decision Trees, SVM |
| [Titanic Survival Prediction](https://github.com/sarikasea/Machine-Learning/blob/main/Titanic_Survival_Prediction.ipynb) | Predict passenger survival outcomes using demographic and travel data. | Maritime / Transportation | Classification, Logistic Regression |
| [Regression Trees - Taxi Tip Prediction](https://github.com/sarikasea/Machine-Learning/blob/main/Regression_Trees_Taxi_Tip_Prediction.ipynb) | Predict taxi tip amounts using regression tree algorithms. | Transportation | Regression Trees |
| [Simple Linear Regression - Fuel Consumption CO2 Emissions](https://github.com/sarikasea/Machine-Learning/blob/main/Simple_Linear_Regression_CO2_Emissions.ipynb) | Predict vehicle CO2 emissions from fuel consumption using a single variable. | Transportation / Environment | Simple Linear Regression |
| [Multiple Linear Regression - Fuel Consumption CO2 Emissions](https://github.com/sarikasea/Machine-Learning/blob/main/Multiple_Linear_Regression_Fuel_Consumption.ipynb) | Extend CO2 emission prediction with multiple fuel-related features. | Transportation / Environment | Multiple Linear Regression |
| [Decision Trees - Prescription Drug Research](https://github.com/sarikasea/Machine-Learning/blob/main/Decision_Trees_Prescription_Drug_Research.ipynb) | Analyze factors influencing prescription drug selection using decision trees. | Healthcare | Decision Trees |
| [Multi-class Classification Obesity - One Hot Encoding](https://github.com/sarikasea/Machine-Learning/blob/main/Multi_class_Classification_Obesity.ipynb) | Classify obesity levels using encoded categorical health and lifestyle data. | Healthcare | Multi-class Classification, One Hot Encoding |
| [Customer Segmentation KNN Classifier](https://github.com/sarikasea/Machine-Learning/blob/main/Customer_Segmentation_KNN_Classifier.ipynb) | Identify customer behavior clusters based on purchasing data with KNN. | Marketing / Retail | K-Nearest Neighbors (KNN) |
| [Random Forest and XGBoost on California Housing Data](https://github.com/sarikasea/Machine-Learning/blob/main/Random_Forests_and_XGBoost.ipynb) | Predict housing values using tree-based ensemble models. | Real Estate | Random Forest, XGBoost |
| [Random Forest Evaluation Metrics](https://github.com/sarikasea/Machine-Learning/blob/main/Random_Forest_Evaluation_Metrics.ipynb) | Measure model performance using random forest evaluation metrics. | Research / Evaluation | Random Forest |
| [Classification Evaluation](https://github.com/sarikasea/Machine-Learning/blob/main/Evaluation_Classification.ipynb) | Compare and analyze classification model performance metrics. | Research / Evaluation | Classification Metrics, ROC-AUC, F1-score |
| [Evaluating K Means](
